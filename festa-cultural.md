...
- **A arte aparece inteira.** O cartaz de cada barraca traz nome e valor escritos nele, então nada é recortado: a imagem vai no topo do card, na largura toda, e a altura sai da proporção dela mesma. Cartaz muito alto para de crescer em 420 px e encolhe inteiro, com faixa nas laterais — nunca cortado. O rodapé do card cola na base, para os botões *Regras* ficarem alinhados entre cards de alturas diferentes.
