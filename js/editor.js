  ...
  return {
    ...
    eventos: {
      ...
      campos: [
        ...
        { name: 'data_evento', label: 'Dia da festa', type: 'date', hint: 'É daqui que sai a contagem regressiva na tela inicial. Vazio, o bloco da contagem nem aparece.' },
        { name: 'hora_evento', label: 'Hora de início', type: 'time', hint: 'A hora que a contagem mira e que vai no evento criado na agenda do celular.' },
        { name: 'hora_fim', label: 'Hora de término', type: 'time', hint: 'Só serve para a agenda. Vazio, o convite dura 4 horas. Pode ser menor que a de início: festa que vira a noite termina no dia seguinte.' },
        { name: 'local_evento', label: 'Local da festa', type: 'text', maxlength: 140, hint: 'Endereço que vai no evento da agenda. Vazio, cai no nome da escola.' },
        ...
        { name: 'equipe_pix_chave', label: 'Equipe · chave PIX', type: 'text', maxlength: 140, hint: 'Quem recebe farda e contribuição da equipe. Vazia, a página da equipe usa o PIX da festa.' },
        { name: 'equipe_pix_favorecido', label: 'Equipe · quem recebe o PIX', type: 'text', maxlength: 140, hint: 'Aparece embaixo da chave, para ninguém pagar sem saber para quem.' },
        { name: 'equipe_pix_cargo', label: 'Equipe · cargo de quem recebe', type: 'text', maxlength: 90, hint: 'Ex.: Coordenador Administrativo.' },
